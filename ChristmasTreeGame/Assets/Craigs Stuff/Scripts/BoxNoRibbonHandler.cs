...
public class BoxNoRibbonHandler : MonoBehaviour, iDecoration
{
    [SerializeField] private int points = 10;
    [SerializeField] private int multiplier = 1;
    private BoxNoRibbonDecoration myDeco;
    ...
    private void Awake()
    {
        myDeco = new BoxNoRibbonDecoration(points, multiplier, upgradeMethod);
    }
